...
We revisit our very first function to see if this test works:
\counterFunc
...
\begin{align}
    ...
    & = 20k^{2} - 20k - 5
\end{align}
We examine the directional function's derivative at $k = 0$:
\begin{align}
    \frac{\mathrm{d}\xi_\vec{v}}{\mathrm{d}k}\point{0} & = 40k - 20\\
    & = -20 \neq 0
\end{align}
Hence $(2, 1)$ is not a local minimum point!
